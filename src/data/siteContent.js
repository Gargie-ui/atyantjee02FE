...
export const pricingPlans = _override?.pricingPlans ?? [
  ...
  },
  {
    ...
    bestFor: 'Students who want complete strategy, clarity & recorded guidance.',
    features: [
      '2 in-depth sessions',
    ...
    bonusLabel: 'Premium Insider Guides Included',
    bonus: [
      'First Year Survival Guide',
      'Coding Roadmap',
      'LinkedIn Growth Guide',
      'Internship Starter Guide',
      'Resume Templates',
      'Networking & Communication Guide',
      'Clubs & Hackathons Guide',
    ],
  ...
  },
  {
    ...
    bestFor: 'Students & parents who want end-to-end handholding till the final round.',
    features: [
      'Everything in Complete Guidance, plus:',
      'Round-wise JoSAA + CSAB support',
      'Freeze / Float / Slide strategy help',
      'Parent clarity session',
      'Final preference list review',
      'Priority WhatsApp support',
      'Backup & alternative pathway planning',
      'Dedicated mentor till final round',
      'All session recordings',
      'Premium Career Starter Kit',
    ],
    bonusLabel: 'Premium Advantage Pack',
    bonus: [
      'Advanced LinkedIn Strategy',
      'Internship Roadmap',
      'Personal Branding for Engineers',
      'Networking & Mentor Finding Guide',
      'Communication & Soft Skills Guide',
      'High-Growth Domains Guide (2025+)',
    ],
